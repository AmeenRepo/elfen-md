...
module.exports = {
	VERSION: 'v5.5.5',
    VERSION: process.env.VERSION || 'v5.5.5',
    ...
    BOT_NAME: process.env.BOT_NAME || 'ΣLFΣП-MD',
    OWNER: process.env.OWNER || '916238768108',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ΣLFΣП-MD;ΛMΣΣП-ƧΣЯ;916238768108;https://i.imgur.com/tlsfqpB.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ΣLFΣП-MD;ΛMΣΣП-ƧΣЯ;https://i.imgur.com/tlsfqpB.jpg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ΣLFΣП-MD;ΛMΣΣП-ƧΣЯ' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '916238768108,0',
       DEBUG: DEBUG
};
